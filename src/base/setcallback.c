...
CallbackType getCallbackTypeFromString(const char *name) {
    ...
    if (len == 5 && name[0] == 'p' && name[1] == 'a' && name[2] == 'u' && 
        name[3] == 's' && name[4] == 'e') {
        fprintf(stderr, "[debug] getCallbackTypeFromString: found CB_PAUSE\n");
        return CB_PAUSE;
    }
    
    if (len == 7 && name[0] == 'c' && name[1] == 'r' && name[2] == 'e' && 
        name[3] == 'd' && name[4] == 'i' && name[5] == 't' && name[6] == 's') {
        fprintf(stderr, "[debug] getCallbackTypeFromString: found CB_CREDITS\n");
        return CB_CREDITS;
    }
    
    if (len == 9 && name[0] == 'c' && name[1] == 'o' && name[2] == 'n' && 
        name[3] == 'f' && name[4] == 'i' && name[5] == 'g' && name[6] == 'u' && 
        name[7] == 'r' && name[8] == 'e') {
        fprintf(stderr, "[debug] getCallbackTypeFromString: found CB_CONFIGURE\n");
        return CB_CONFIGURE;
    }
    
    if (len == 8 && name[0] == 't' && name[1] == 'i' && name[2] == 'm' && 
        name[3] == 'e' && name[4] == 'd' && name[5] == 'e' && name[6] == 'm' && 
        name[7] == 'o') {
